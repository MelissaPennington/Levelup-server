# Generated by Django 4.1.3 on 2023-11-15 02:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='attendees', to='levelupapi.event')),
                ('gamer', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='levelupapi.gamer')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name='events', to='levelupapi.game'),
        ),
        migrations.AddField(
            model_name='event',
            name='organizer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='user_event', to='levelupapi.gamer'),
        ),
    ]
